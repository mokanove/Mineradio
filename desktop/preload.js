...
contextBridge.exposeInMainWorld("desktopWindow", {
  ...
  toggleFullscreen: () =>
    ipcRenderer.invoke("desktop-window-toggle-fullscreen"),
  exitFullscreenWindowed: () =>
  ...
  trimAppMemory: (payload) =>
    ipcRenderer.invoke("mineradio-memory-trim-app", payload || {}),
  purgeSystemMemory: (payload) =>
    ipcRenderer.invoke("mineradio-memory-purge-system", payload || {}),
  getCacheSettings: () => ipcRenderer.invoke("mineradio-cache-get-settings"),
  chooseCacheDirectory: () =>
    ipcRenderer.invoke("mineradio-cache-choose-directory"),
  setCacheSettings: (payload) =>
    ipcRenderer.invoke("mineradio-cache-set-settings", payload || {}),
  listWallpaperEngineProjects: (payload) =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-list", payload || {}),
  getWallpaperEngineProjectDetails: (id) =>
    ipcRenderer.invoke(
      "mineradio-wallpaper-engine-project-details",
      String(id || ""),
    ),
  openWallpaperEngineProjectDetails: (id, target) =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-open-project-details", {
      id: String(id || ""),
      target: target === "workshop" ? "workshop" : "we",
    }),
  chooseWallpaperEngineDirectory: () =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-choose-directory"),
  chooseWallpaperEngineProjectFile: () =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-choose-project-file"),
  removeWallpaperEngineDirectory: (rootId) =>
    ipcRenderer.invoke(
  ...
  startWallpaperEngineScene: (payload) =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-start-scene", payload || {}),
  reportWallpaperEngineCaptureResult: (payload) =>
    ipcRenderer.invoke(
      "mineradio-wallpaper-engine-capture-result",
      payload || {},
    ),
  prepareWallpaperEngineGlassCapture: (payload) =>
    ipcRenderer.invoke(
      "mineradio-wallpaper-engine-prepare-glass-capture",
      payload || {},
    ),
  activateWallpaperEngineDwmSurface: (payload) =>
    ipcRenderer.invoke(
      "mineradio-wallpaper-engine-activate-dwm-surface",
      payload || {},
    ),
  updateWallpaperEngineGlassSurface: (payload) =>
    ipcRenderer.send("mineradio-wallpaper-engine-glass-surface", payload || {}),
  reportWallpaperEnginePointerActivity: (payload) =>
    ipcRenderer.send(
      "mineradio-wallpaper-engine-pointer-activity",
      payload || {},
    ),
  stopWallpaperEngineScene: (payload) =>
    ipcRenderer.invoke("mineradio-wallpaper-engine-stop-scene", payload || {}),
  ...
  writeLyricCache: (key, payload) =>
    ipcRenderer.invoke("mineradio-cache-write-lyric", key || "", payload || {}),
  close: (behavior) => ipcRenderer.invoke("desktop-window-close", behavior),
  getCloseBehavior: () =>
    ipcRenderer.invoke("desktop-window-get-close-behavior"),
  setCloseBehavior: (behavior) =>
    ipcRenderer.invoke("desktop-window-set-close-behavior", behavior),
  getLoginEasterEggStatus: () =>
    ipcRenderer.invoke("mineradio-login-easter-egg-status"),
  ...
  resetLoginEasterEgg: () =>
    ipcRenderer.invoke("mineradio-login-easter-egg-reset"),
  ...
  openQQMusicLogin: (options) =>
    ipcRenderer.invoke("qq-music-open-login", options || {}),
  ...
  exportJsonFile: (payload) =>
    ipcRenderer.invoke("mineradio-export-json-file", payload || {}),
  exportLoginCookie: (provider) =>
    ipcRenderer.invoke("mineradio-export-login-cookie", provider || ""),
  importJsonFile: () => ipcRenderer.invoke("mineradio-import-json-file"),
  readCurrentFxAutosaveSync: () =>
    ipcRenderer.sendSync("mineradio-current-fx-autosave-read-sync"),
  saveCurrentFxAutosaveSync: (payload) =>
    ipcRenderer.sendSync(
      "mineradio-current-fx-autosave-save-sync",
      payload || {},
    ),
  saveCurrentFxAutosave: (payload) =>
    ipcRenderer.invoke("mineradio-current-fx-autosave-save", payload || {}),
  onGlobalHotkey: (callback) => {
    if (typeof callback !== "function") return () => {};
    const listener = (_event, payload) => callback(payload || {});
    ipcRenderer.on("mineradio-global-hotkey", listener);
    return () =>
      ipcRenderer.removeListener("mineradio-global-hotkey", listener);
  },
  ...
  updateDesktopLyrics: (payload) =>
    ipcRenderer.invoke("mineradio-desktop-lyrics-update", payload || {}),
  ...
  updateWallpaperMode: (payload) =>
    ipcRenderer.invoke("mineradio-wallpaper-update", payload || {}),
  getWallpaperModeStatus: () =>
    ipcRenderer.invoke("mineradio-wallpaper-get-status"),
  updateDesktopIconShields: (payload) =>
    ipcRenderer.send("mineradio-full-desktop-icon-shields", payload || {}),
  setDesktopSoftwareLocked: (locked) =>
    ipcRenderer.invoke(
  ...
  updateDesktopPointerRoute: (payload) =>
    ipcRenderer.send("mineradio-full-desktop-pointer-route", {
  ...
  onWallpaperModeState: (callback) => {
    ...
    return () =>
      ipcRenderer.removeListener("mineradio-wallpaper-runtime-state", listener);
  },
