...
var HOTKEY_ACTIONS = [
  ...
  },
  {
    ...
    category: "窗口",
    local: "KeyF",
    global: "Ctrl+Alt+KeyF",
  },
  {
    key: "toggleDesktopInteraction",
    label: "切换完整桌面模式",
    category: "窗口",
    local: "",
    global: "Ctrl+Shift+KeyM",
  },
  {
    key: "toggleDesktopLyrics",
    label: "桌面歌词",
    category: "歌词",
    local: "Alt+KeyL",
    global: "Ctrl+Alt+KeyL",
  },
];
...
var collectTargetSong = null,
  collectBusy = false;
var uploadTipTimer = null,
  uploadTipAttempts = 0;
var visualGuideActive = false,
  visualGuideStep = 0,
  visualGuideResizeBound = false;
var visualGuideState = {
  bottomWasVisible: false,
  searchWasPeek: false,
  manual: false,
};
