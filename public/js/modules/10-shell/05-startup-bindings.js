function applyDesktopPlatformCapabilities() {
  ...
  document.body.classList.toggle('platform-non-windows', !!platform && !isWindows);
  ...
  document.querySelectorAll('.memory-action-row button').forEach(function (button, index) {
