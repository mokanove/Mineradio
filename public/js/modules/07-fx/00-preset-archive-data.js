...
var presetMeta = [
  ...
  { name: "星河", desc: "壁纸粒子 · 音乐律动" },
  {
    name: "安魂",
    desc: "骷髅·YUI7W",
    descHtml: '骷髅·<span class="pc-yui7w">YUI7W</span>',
  },
  {
    name: "音域回响",
...
function archiveHasVisualRotationState(raw) {
  if (!raw || typeof raw !== "object") return false;
  return (
    raw.visualRotationSaved === true ||
    raw.visualRotationX != null ||
    raw.visualRotationY != null
  );
}
function isCameraArchiveKey(key) {
  return (
    /^camera(View|Orbit|Free)/.test(String(key || "")) ||
    /^visualRotation/.test(String(key || ""))
  );
}
function normalizeFxArchiveSnapshot(raw) {
  ...
  var archiveShelfPresence =
    archiveShelfMode === "off"
      ? "auto"
      : archiveMode(
          raw,
          "shelfPresence",
          /^(auto|always)$/,
          fxDefaults.shelfPresence,
        );
  var archiveShelfPinnedOpen =
    archiveShelfMode === "side" &&
    archiveShelfPresence === "always" &&
  ...
  return {
    ...
    lyricGlowStrength: archiveNumber(
      raw,
      "lyricGlowStrength",
    ...
    lyricBackgroundAdapt: archiveNumber(
      raw,
      "lyricBackgroundAdapt",
    ...
    lyricScale: archiveNumber(
      raw,
      "lyricScale",
      fxDefaults.lyricScale,
      0.35,
      1.65,
    ),
    lyricOffsetX: archiveNumber(
      raw,
      "lyricOffsetX",
      fxDefaults.lyricOffsetX,
      -4.0,
      4.0,
    ),
    lyricOffsetY: archiveNumber(
      raw,
      "lyricOffsetY",
      fxDefaults.lyricOffsetY,
      -2.4,
      2.7,
    ),
    lyricOffsetZ: archiveNumber(
      raw,
      "lyricOffsetZ",
      fxDefaults.lyricOffsetZ,
      -3.2,
      3.2,
    ),
    lyricTiltX: archiveNumber(
      raw,
      "lyricTiltX",
      fxDefaults.lyricTiltX,
      -84,
      84,
    ),
    lyricTiltY: archiveNumber(
      raw,
      "lyricTiltY",
      fxDefaults.lyricTiltY,
      -84,
      84,
    ),
    ...
    lyricDisplayMode: normalizeLyricDisplayMode(
      raw.lyricDisplayMode || fxDefaults.lyricDisplayMode,
    ),
    lyricTranslationMode: normalizeLyricTranslationMode(
      raw.lyricTranslationMode || fxDefaults.lyricTranslationMode,
    ),
    lyricMotionStyle: normalizeLyricMotionStyle(
      raw.lyricMotionStyle || fxDefaults.lyricMotionStyle,
    ),
    lyricCustomLineCount: archiveNumber(
      raw,
      "lyricCustomLineCount",
    ...
    lyricGlitchIntensity: archiveNumber(
      raw,
      "lyricGlitchIntensity",
    ...
    lyricGlitchSlice: archiveNumber(
      raw,
      "lyricGlitchSlice",
    ...
    lyricGlitchChroma: archiveNumber(
      raw,
      "lyricGlitchChroma",
    ...
    lyricGlitchJitter: archiveNumber(
      raw,
      "lyricGlitchJitter",
    ...
    lyricContextOpacity: archiveNumber(
      raw,
      "lyricContextOpacity",
    ...
    lyricContextSpread: archiveNumber(
      raw,
      "lyricContextSpread",
    ...
    lyricTranslationGap: archiveNumber(
      raw,
      "lyricTranslationGap",
    ...
    lyricTranslationScale: archiveNumber(
      raw,
      "lyricTranslationScale",
    ...
    lyricTranslationOpacity: archiveNumber(
      raw,
      "lyricTranslationOpacity",
    ...
    lyricMotionSoftness: archiveNumber(
      raw,
      "lyricMotionSoftness",
    ...
    lyricLetterSpacing: archiveNumber(
      raw,
      "lyricLetterSpacing",
      fxDefaults.lyricLetterSpacing,
      -0.04,
      0.18,
    ),
    lyricLineHeight: archiveNumber(
      raw,
      "lyricLineHeight",
      fxDefaults.lyricLineHeight,
      0.72,
      1.8,
    ),
    lyricWeight: archiveNumber(
      raw,
      "lyricWeight",
      fxDefaults.lyricWeight,
      500,
      900,
    ),
    ...
    visualTintColor: normalizeHexColor(
      raw.visualTintColor || fxDefaults.visualTintColor,
    ),
    uiAccentColor: normalizeHexColor(
      raw.uiAccentColor || fxDefaults.uiAccentColor,
      fxDefaults.uiAccentColor,
    ),
    homeAccentColor: normalizeHexColor(
      raw.homeAccentColor || fxDefaults.homeAccentColor,
      fxDefaults.homeAccentColor,
    ),
    homeIconColor: normalizeHexColor(
      raw.homeIconColor || fxDefaults.homeIconColor,
      fxDefaults.homeIconColor,
    ),
    visualIconColor: normalizeHexColor(
      raw.visualIconColor || fxDefaults.visualIconColor,
      fxDefaults.visualIconColor,
    ),
    backgroundColorMode:
      raw.backgroundColorMode === "custom" || raw.backgroundColorCustom
        ? "custom"
        : "cover",
    backgroundColor: normalizeHexColor(
      raw.backgroundColor || fxDefaults.backgroundColor,
      fxDefaults.backgroundColor,
    ),
    backgroundOpacity: archiveNumber(
      raw,
      "backgroundOpacity",
    ...
    backgroundMediaCropX: archiveNumber(
      raw,
      "backgroundMediaCropX",
    ...
    backgroundMediaCropY: archiveNumber(
      raw,
      "backgroundMediaCropY",
    ...
    backgroundMediaZoom: archiveNumber(
      raw,
      "backgroundMediaZoom",
    ...
    windowBackgroundOpacity: archiveNumber(
      raw,
      "windowBackgroundOpacity",
    ...
    backgroundGlassOpacity: archiveNumber(
      raw,
      "backgroundGlassOpacity",
    ...
    controlGlassChromaticOffset: archiveNumber(
      raw,
      "controlGlassChromaticOffset",
    ...
    playlistPanelGlassBlur: archiveNumber(
      raw,
      "playlistPanelGlassBlur",
    ...
    playlistPanelGlassDensity: archiveNumber(
      raw,
      "playlistPanelGlassDensity",
    ...
    playlistPanelOpenDuration: archiveNumber(
      raw,
      "playlistPanelOpenDuration",
    ...
    playlistPanelCloseDuration: archiveNumber(
      raw,
      "playlistPanelCloseDuration",
    ...
    desktopLyricsSize: archiveNumber(
      raw,
      "desktopLyricsSize",
      fxDefaults.desktopLyricsSize,
      0.72,
      1.55,
    ),
    desktopLyricsOpacity: archiveNumber(
      raw,
      "desktopLyricsOpacity",
    ...
    desktopLyricsFps: normalizeDesktopLyricsFps(
      Object.prototype.hasOwnProperty.call(raw, "desktopLyricsFps")
        ? raw.desktopLyricsFps
    ...
    memorySystemIntervalMin: archiveNumber(
      raw,
      "memorySystemIntervalMin",
    ...
    memorySystemThresholdPercent: archiveNumber(
      raw,
      "memorySystemThresholdPercent",
    ...
    memorySystemMask: archiveNumber(
      raw,
      "memorySystemMask",
    ...
    sonicGroundAmplitude: archiveNumber(
      raw,
      "sonicGroundAmplitude",
    ...
    sonicGroundMotionSpeed: archiveNumber(
      raw,
      "sonicGroundMotionSpeed",
    ...
    sonicGroundDensity: archiveNumber(
      raw,
      "sonicGroundDensity",
    ...
    sonicGroundRange: archiveNumber(
      raw,
      "sonicGroundRange",
    ...
    sonicGroundLower: archiveNumber(
      raw,
      "sonicGroundLower",
    ...
    sonicGroundDepth: archiveNumber(
      raw,
      "sonicGroundDepth",
    ...
    sonicGroundAutoRotate: archiveNumber(
      raw,
      "sonicGroundAutoRotate",
    ...
    sonicGroundSubBass: archiveNumber(
      raw,
      "sonicGroundSubBass",
    ...
    sonicGroundLowMid: archiveNumber(
      raw,
      "sonicGroundLowMid",
    ...
    sonicGroundHighMid: archiveNumber(
      raw,
      "sonicGroundHighMid",
    ...
    sonicGroundPresence: archiveNumber(
      raw,
      "sonicGroundPresence",
    ...
    sonicGroundBrilliance: archiveNumber(
      raw,
      "sonicGroundBrilliance",
    ...
    sonicGroundFloatingIntensity: archiveNumber(
      raw,
      "sonicGroundFloatingIntensity",
    ...
    sonicGroundFloatingMinSize: archiveNumber(
      raw,
      "sonicGroundFloatingMinSize",
    ...
    sonicGroundFloatingMaxSize: archiveNumber(
      raw,
      "sonicGroundFloatingMaxSize",
    ...
    sonicGroundFloatingSpeed: archiveNumber(
      raw,
      "sonicGroundFloatingSpeed",
    ...
    sonicGroundFloatingCount: archiveNumber(
      raw,
      "sonicGroundFloatingCount",
    ...
    sonicAudioSensitivity: archiveNumber(
      raw,
      "sonicAudioSensitivity",
    ...
    sonicAudioBandStart: archiveNumber(
      raw,
      "sonicAudioBandStart",
    ...
    sonicAudioBandEnd: archiveNumber(
      raw,
      "sonicAudioBandEnd",
    ...
    sonicAudioThreshold: archiveNumber(
      raw,
      "sonicAudioThreshold",
    ...
    sonicAudioPulseStrength: archiveNumber(
      raw,
      "sonicAudioPulseStrength",
    ...
    sonicWorkshopInputGain: archiveNumber(
      raw,
      "sonicWorkshopInputGain",
    ...
    sonicWorkshopAudioIntensity: archiveNumber(
      raw,
      "sonicWorkshopAudioIntensity",
    ...
    sonicWorkshopResponseRange: archiveNumber(
      raw,
      "sonicWorkshopResponseRange",
    ...
    sonicWorkshopPeakIntensity: archiveNumber(
      raw,
      "sonicWorkshopPeakIntensity",
    ...
    sonicWorkshopTheme: archiveMode(
      raw,
      "sonicWorkshopTheme",
      /^(coral-mirage|ocean-deep|arctic-blue|arctic-aurora|emerald-forest|cyber-forest|minimal-mono|minimal-monochrome|neon-tokyo|golden-hour|ember-fire|crimson|crimson-sunset|aurora|violet-dream)$/,
    ...
    shelfCameraMode: archiveMode(
      raw,
      "shelfCameraMode",
      /^(dynamic|static)$/,
      fxDefaults.shelfCameraMode,
    ),
    ...
    shelfSize: archiveNumber(
      raw,
      "shelfSize",
      fxDefaults.shelfSize,
      0.65,
      1.45,
    ),
    shelfOffsetX: archiveNumber(
      raw,
      "shelfOffsetX",
    ...
    shelfDetailOffsetX: archiveNumber(
      raw,
      "shelfDetailOffsetX",
    ...
    shelfDetailOffsetY: archiveNumber(
      raw,
      "shelfDetailOffsetY",
    ...
    shelfDetailOffsetZ: archiveNumber(
      raw,
      "shelfDetailOffsetZ",
    ...
    shelfDetailScale: archiveNumber(
      raw,
      "shelfDetailScale",
    ...
    shelfDetailAngleX: archiveNumber(
      raw,
      "shelfDetailAngleX",
    ...
    shelfDetailAngleY: archiveNumber(
      raw,
      "shelfDetailAngleY",
    ...
    shelfDetailRowGap: archiveNumber(
      raw,
      "shelfDetailRowGap",
    ...
    shelfDetailOpenDuration: archiveNumber(
      raw,
      "shelfDetailOpenDuration",
    ...
    shelfDetailCloseDuration: archiveNumber(
      raw,
      "shelfDetailCloseDuration",
    ...
    shelfDetailRowDuration: archiveNumber(
      raw,
      "shelfDetailRowDuration",
    ...
    shelfDetailIntroStrength: archiveNumber(
      raw,
      "shelfDetailIntroStrength",
    ...
    shelfDetailParallax: archiveNumber(
      raw,
      "shelfDetailParallax",
    ...
    shelfSummonOpenDuration: archiveNumber(
      raw,
      "shelfSummonOpenDuration",
    ...
    shelfSummonCloseDuration: archiveNumber(
      raw,
      "shelfSummonCloseDuration",
    ...
    shelfSummonSlide: archiveNumber(
      raw,
      "shelfSummonSlide",
    ...
    shelfSummonStagger: archiveNumber(
      raw,
      "shelfSummonStagger",
    ...
    shelfSummonScale: archiveNumber(
      raw,
      "shelfSummonScale",
    ...
    shelfSummonParallax: archiveNumber(
      raw,
      "shelfSummonParallax",
    ...
    shelfCameraEnterSpeed: archiveNumber(
      raw,
      "shelfCameraEnterSpeed",
    ...
    shelfCameraExitSpeed: archiveNumber(
      raw,
      "shelfCameraExitSpeed",
    ...
    cameraViewMode: archiveMode(
      raw,
      "cameraViewMode",
      /^(orbit|free)$/,
      "orbit",
    ),
    cameraOrbitTheta: archiveNumber(
      raw,
      "cameraOrbitTheta",
      0,
      -Math.PI * 8,
    ...
    cameraFreePositionZ: archiveNumber(
      raw,
      "cameraFreePositionZ",
      6.6,
      -80,
...
function readUserFxArchives() {
  ...
  try {
    raw =
      JSON.parse(localStorage.getItem(USER_FX_ARCHIVE_STORE_KEY) || "[]") || [];
  } catch (e) {
    raw = [];
  }
    ...
    .map(function (slot, index) {
      ...
      return {
        ...
        createdAt:
          ...
          (snapshot ? Number(slot.savedAt) || Date.now() : 0),
...
function saveUserFxArchives() {
  try {
    localStorage.setItem(
      USER_FX_ARCHIVE_STORE_KEY,
      JSON.stringify(userFxArchives),
    );
  } catch (e) {
...
function captureCameraArchiveState() {
  var useFree = !!(
    typeof freeCamera !== "undefined" &&
    freeCamera &&
    (freeCamera.active || freeCamera.locked)
  );
  var visualRotX =
    typeof particles !== "undefined" && particles && particles.rotation
      ? Number(particles.rotation.x) || 0
      : typeof gestureRotation !== "undefined" && gestureRotation
        ? Number(gestureRotation.x) || 0
        : 0;
  var visualRotY =
    typeof particles !== "undefined" && particles && particles.rotation
      ? Number(particles.rotation.y) || 0
      : typeof gestureRotation !== "undefined" && gestureRotation
        ? Number(gestureRotation.y) || 0
        : 0;
  var out = {
    ...
    cameraOrbitRadius:
      orbit && isFinite(orbit.userRadius) ? orbit.userRadius : 6.6,
...
function applyVisualRotationArchiveState(data) {
  ...
  if (typeof particles !== "undefined" && particles && particles.rotation)
    particles.rotation.set(rx, ry, 0);
  if (
    typeof bloomParticles !== "undefined" &&
    bloomParticles &&
    bloomParticles.rotation
  )
    bloomParticles.rotation.set(rx, ry, 0);
  if (typeof floatGroup !== "undefined" && floatGroup && floatGroup.rotation)
    floatGroup.rotation.set(rx, ry, 0);
  if (
    typeof backCoverGroup !== "undefined" &&
    backCoverGroup &&
    backCoverGroup.rotation
  )
    backCoverGroup.rotation.set(rx, ry, 0);
  if (
    typeof orbit !== "undefined" &&
    orbit &&
    (Math.abs(rx) > 0.0001 || Math.abs(ry) > 0.0001)
  ) {
...
function applyCameraArchiveState(data) {
  ...
  if (typeof freeCamera !== "undefined" && freeCamera) {
    ...
    if (typeof releaseFreeCameraPointerLock === "function")
      releaseFreeCameraPointerLock();
  }
  if (
    data.cameraViewMode === "free" &&
    typeof freeCamera !== "undefined" &&
    freeCamera
  ) {
    if (!freeCamera.position) freeCamera.position = new THREE.Vector3();
    freeCamera.position.set(
      data.cameraFreePositionX,
      data.cameraFreePositionY,
      data.cameraFreePositionZ,
    );
  ...
  if (typeof orbit !== "undefined" && orbit) {
    ...
    if (typeof clearCenteredViewOffsets === "function")
      clearCenteredViewOffsets();
    if (typeof requestStageLyricCameraSnap === "function")
...
function captureFxArchiveSnapshot() {
  return normalizeFxArchiveSnapshot(
    Object.assign(
      { visualPresetSchema: VISUAL_PRESET_SCHEMA },
      fx,
      captureCameraArchiveState(),
    ),
  );
}
...
function applyFxArchiveSnapshot(snapshot) {
  ...
  if (fx.shelf === "side")
    setShelfPinnedOpen(!!fx.shelfPinnedOpen, true, false);
...
function renderUserFxArchives() {
  ...
  if (!grid) return;
  grid.innerHTML = userFxArchives
    .map(function (slot, index) {
      var hasSave = !!slot.snapshot;
      var editing = userFxArchiveEditing === index;
      var nameHtml = editing
        ? '<input class="user-archive-input" id="user-archive-input-' +
          index +
          '" type="text" maxlength="18" value="' +
          escHtml(slot.name) +
          '" onkeydown="handleUserFxArchiveRenameKey(event,' +
          index +
          ')">'
        : '<div class="user-archive-name" title="' +
          escHtml(slot.name) +
          '">' +
          escHtml(slot.name) +
          "</div>";
      var actionsHtml = editing
        ? '<button type="button" onclick="commitUserFxArchiveRename(' +
          index +
          ')">确定</button>' +
          '<button type="button" onclick="cancelUserFxArchiveRename()">取消</button>'
        : '<button type="button" onclick="applyUserFxArchive(' +
          index +
          ')"' +
          (hasSave ? "" : " disabled") +
          ">应用</button>" +
          '<button type="button" onclick="saveUserFxArchive(' +
          index +
          ')">保存</button>' +
          '<button type="button" onclick="renameUserFxArchive(' +
          index +
          ')">命名</button>';
      return (
        '<div class="user-archive-slot' +
        (hasSave ? " has-save" : "") +
        '" data-slot="' +
        index +
        '">' +
        ...
        formatUserArchiveTime(slot.savedAt) +
        "</div>" +
  ...
  if (userFxArchiveEditing >= 0) {
    setTimeout(function () {
      var input = document.getElementById(
        "user-archive-input-" + userFxArchiveEditing,
      );
      if (input) {
        input.focus();
        input.select();
...
function saveUserFxArchive(index) {
  index = clampRange(
    Number(index) || 0,
    0,
    Math.max(0, userFxArchives.length - 1),
  );
  userFxArchives[index].snapshot = captureFxArchiveSnapshot();
  userFxArchives[index].savedAt = Date.now();
  userFxArchives[index].name = normalizeUserFxArchiveName(
    userFxArchives[index].name,
    index,
  );
  saveUserFxArchives();
...
function userFxArchiveAt(index) {
  ...
  return index >= 0 && index < userFxArchives.length
    ? userFxArchives[index]
    : null;
}
...
async function gzipUserFxShareText(text) {
  ...
  var stream = new Blob([String(text || "")])
    .stream()
...
function userFxShareBaselineSnapshot() {
  ...
  try {
    raw =
      typeof clonePackagedDefaultFxSnapshot === "function"
...
function compactUserFxArchiveSnapshot(snapshot) {
  var data = normalizeFxArchiveSnapshot(snapshot);
  if (!data) return null;
  var full = USER_FX_SHARE_KEYS.map(function (key) {
    return data[key];
  });
  var base = userFxShareBaselineSnapshot();
  var delta = [];
  USER_FX_SHARE_KEYS.forEach(function (key, index) {
    if (!userFxShareValueEqual(data[key], base[key]))
      delta.push(index, data[key]);
  });
  var compactDelta = [USER_FX_SHARE_COMPACT_DELTA, delta];
  var compactFull = [USER_FX_SHARE_COMPACT_FULL, full];
  return JSON.stringify(compactDelta).length <=
    JSON.stringify(compactFull).length
    ? compactDelta
    : compactFull;
}
function expandUserFxArchiveSnapshot(compact) {
  ...
  var mode =
    typeof compact[0] === "string" ? compact[0] : USER_FX_SHARE_COMPACT_FULL;
  var values = typeof compact[0] === "string" ? compact[1] : compact;
  if (!Array.isArray(values)) return null;
  var raw =
    mode === USER_FX_SHARE_COMPACT_DELTA ? userFxShareBaselineSnapshot() : {};
  if (mode === USER_FX_SHARE_COMPACT_DELTA) {
    for (var i = 0; i < values.length - 1; i += 2) {
      var deltaIndex = Math.floor(Number(values[i]));
      if (deltaIndex >= 0 && deltaIndex < USER_FX_SHARE_KEYS.length)
        raw[USER_FX_SHARE_KEYS[deltaIndex]] = values[i + 1];
    }
  } else {
    USER_FX_SHARE_KEYS.forEach(function (key, index) {
...
async function encodeUserFxArchiveShareCode(slot) {
  ...
  return (
    USER_FX_SHARE_PREFIX +
    ":" +
    version +
    "." +
    body +
    "." +
    userFxShareChecksum(version + "." + body)
  );
}
function extractUserFxShareCode(text) {
  text = String(text || "").trim();
  var direct = text.replace(/\s+/g, "");
  if (/^MR2:[0-9]+\.[A-Za-z][A-Za-z0-9_-]+\.[A-Za-z0-9]+$/.test(direct))
    return direct;
...
async function decodeUserFxArchiveShareCode(text) {
  ...
  if (version !== String(USER_FX_SHARE_VERSION))
    throw new Error("UNSUPPORTED_SHARE_VERSION");
  if (userFxShareChecksum(version + "." + body) !== checksum)
    throw new Error("BAD_SHARE_CHECKSUM");
  ...
  return {
    name: normalizeUserFxArchiveName(
      archiveName || "短代码存档",
      userFxArchives.length,
    ),
    createdAt: Date.now(),
...
function getArchiveClipboardApi() {
  return typeof getDesktopWindowApi === "function"
    ? getDesktopWindowApi()
    : null;
}
...
async function copyUserFxArchiveShareCode(index) {
  ...
  try {
    ...
    if (copied) {
      showToast(
        code.length > 12000 ? "完整短码已复制，配置较长" : "用户存档短码已复制",
      );
    } else {
...
async function importUserFxArchiveShareCodeText(text) {
  try {
    ...
    showToast(
      e && e.message === "BAD_SHARE_CHECKSUM"
        ? "短码校验失败，未导入"
        : "短码无效，未导入",
    );
    return false;
...
async function pasteUserFxArchiveShareCodeToBox() {
  ...
  showToast(
    looksLikeUserFxShareCode(text)
      ? "短码已粘到输入框"
      : "已粘到输入框，可尝试作为旧 JSON 导入",
  );
  return true;
}
...
function renderUserFxArchives() {
  ...
  var shareBox =
    ...
    '<textarea id="user-archive-share-input" class="user-archive-share-input" spellcheck="false" placeholder="把 MR2 短代码粘到这里，也兼容旧 JSON 存档" oninput="updateUserFxArchiveShareDraft(this.value)" onkeydown="handleUserFxArchiveShareInputKey(event)">' +
    escHtml(userFxArchiveShareDraft) +
    "</textarea>" +
  ...
  var cards = userFxArchives
    .map(function (slot, index) {
      ...
      var actionsHtml = editing
        ...
        : '<button type="button" onclick="applyUserFxArchive(' +
          ...
          index +
          ')">保存</button>' +
          '<button type="button" onclick="copyUserFxArchiveShareCode(' +
          index +
          ')"' +
          (hasSave ? "" : " disabled") +
          ">复制码</button>" +
          ...
          index +
          ')">命名</button>' +
          '<button type="button" onclick="exportUserFxArchive(' +
          index +
          ')"' +
          (hasSave ? "" : " disabled") +
          ">文件</button>" +
          '<button type="button" onclick="removeUserFxArchive(' +
          index +
          ')">删除</button>';
      return (
        '<div class="user-archive-slot' +
    ...
    .join("");
  var addCard =
    '<button class="user-archive-slot is-new" type="button" onclick="createUserFxArchive()"><strong>＋ 新建空白存档</strong><span class="user-archive-meta">可继续创建，不限制 4 个</span></button>';
...
function exportUserFxArchive(index) {
  ...
  if (api && typeof api.exportJsonFile === "function") {
    api
      .exportJsonFile({
        defaultName: safeArchiveFileName(slot.name),
        text: text,
      })
      .then(function (res) {
...
function normalizeImportedFxArchivePayload(payload, fileName) {
  ...
  var snapshot = payload.snapshot
    ? normalizeFxArchiveSnapshot(payload.snapshot)
    : normalizeFxArchiveSnapshot(payload);
...
async function importUserFxArchiveText(text, fileName) {
  if (looksLikeUserFxShareCode(text))
    return importUserFxArchiveShareCodeText(text);
  var payload = null;
  try {
...
function importUserFxArchiveFromDialog() {
  ...
  if (api && typeof api.importJsonFile === "function") {
    api
      ...
      .then(function (res) {
        if (res && res.ok)
          importUserFxArchiveText(res.text, res.filePath || "用户存档.json");
...
function readUserFxArchiveImportFile(file) {
  ...
  reader.onload = function (e) {
    importUserFxArchiveText(e.target && e.target.result, file.name);
  };
